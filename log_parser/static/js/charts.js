...
var data_usage = new Pie('#uid-data-chart', '#uid-data-data', data_columns, 'uid_data.json');
...
var end_reasons = new Pie('#end-reasons-chart', '#end-reasons-data', data_columns, 'end_reasons.json', 300, 300);
...
var relay_p2p_counts = new Pie('#relay-p2p-chart', '#relay-p2p-data', data_columns, 'relay_p2p_counts.json', 300, 300);
